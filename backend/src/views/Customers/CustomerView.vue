        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
              ...
              <CustomInput v-model="customer.billingAddress.country" label="Zip Code" :errors="errors['billingAddress.country']"/>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
              ...
              <CustomInput v-model="customer.shippingAddress.country" label="Zip Code" :errors="errors['shippingAddress.country']"/>
...
onMounted(() => {
  store.dispatch('getCountries').then(() => {
    console.log("Countries Data:", store.state.countries); // Check countries
    ...
    store.dispatch('getCustomer', route.params.id)
      .then(({ data }) => {
        ...
        console.log("Mapped Billing Country:", billingCountry);
        console.log("Mapped Shipping Country:", shippingCountry);
