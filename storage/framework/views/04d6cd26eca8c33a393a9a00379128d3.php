<header
      ...
      cartItemsCount: <?php echo e(\App\Http\Helpers\Cart::getCartItemsCount()); ?>,
      }"
      @cart-change.window="cartItemsCount = $event.detail.count"
      class="flex justify-between bg-slate-800 shadow-md text-white"
    >
      <div>
        <a href="<?php echo e(route('home')); ?>" class="block py-navbar-item pl-5"> Home </a>
      </div>
      <!-- Responsive Menu -->
      <div
            ...
            >
              ...
              <li class="hover:bg-slate-900">
                <form action="<?php echo e(route('logout')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="flex w-full item-center px-3 py-2 hover:bg-slate-900">
                        <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 mr-2"
                    fill="none"
    ...
    </header><?php /**PATH C:\Users\rudra\Desktop\Laravel_New\laravel_Ecommerce\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>