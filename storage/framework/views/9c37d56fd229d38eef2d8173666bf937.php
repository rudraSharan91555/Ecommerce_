...
<?php endif; ?>
    ...
    <form method="POST" class="w-[400px] mx-auto p-6 my-16" action="<?php echo e(route('password.email')); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\rudra\Desktop\Laravel_New\laravel_Ecommerce\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>